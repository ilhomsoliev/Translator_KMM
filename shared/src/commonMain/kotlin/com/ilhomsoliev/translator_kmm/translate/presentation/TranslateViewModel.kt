...
import com.ilhomsoliev.translator_kmm.core.domain.util.Resource
import com.ilhomsoliev.translator_kmm.core.domain.util.toCommonStateFlow
...
import com.ilhomsoliev.translator_kmm.translate.domain.translate.TranslateException
...
class TranslateViewModel(
    ...
    fun onEvent(event: TranslateEvent) {
        when (event) {
            ...
            is TranslateEvent.DeleteHistory -> {
                viewModelScope.launch {
                    historyDataSource.deleteHistory(event.id)
                }
            }
